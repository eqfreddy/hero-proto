...
from app.routers import achievements, admin, afk as afk_router, ai, announcements, arena, auth, battle_pass, battles, crafting, daily, events, friend_points as friend_points_router, friends, gear, guilds, heroes, i18n as i18n_router, inventory, liveops, me, monthly_card as monthly_card_router, notifications, quests, raids, shop, stages, story, summon, ui, vip as vip_router
...
app.include_router(friend_points_router.router)
