...
import { BattleV2Route } from './routes/BattleV2'
  ...
  { path: '/', element: <Navigate to="/app/me" replace /> },
  {
    ...
    children: [
      ...
      { path: 'roster', children: [
        ...
        { path: 'legacy', element: <RosterRoute /> },
        { path: ':heroId', element: <HeroDetailRoute /> },
      ]},
      { path: 'summon', element: <SummonV2Route /> },
      { path: 'summon/results', element: <SummonV2ResultsRoute /> },
      { path: 'summon/legacy', element: <SummonRoute /> },
